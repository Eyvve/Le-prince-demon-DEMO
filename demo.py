...
2. Vieille tour de garde (ouest)
        ...
        while choix != "1" or choix != "2":
            ...
            choix = str(input())
        print("Champ de bataille de la citadelle - Batisse Royale (hall)")
        print("")
        ...
        Sentence("A la différence près que tout ce attirail avait une taille suffisante pour restreindre les mouvements d'une créature massive,")
        ...
        print("")
        Sentence("vou suivez vous même votre conseil.")
        menu_roi()
        Sentence("")
        ...
        sleep(1.0)
        throne_theme.play(-1)
        print("Champ de bataille de la citadelle - Batisse Royale (salle du trône)")
        print("")
