...
def portes():
    ...
    Sentence("Zazranoth, son général, et Ginn, son aide de camp viennent vers lui, se mouvant dans le charnier avec")
    Sentence("difficulté, le visage de l'un grave, celui de l'autre en détresse. Mon seigneur, l'interpelle le vétéran,")
...
def assautportes():
    ...
    Sentence("forteresse. Faisant fi des projectiles et du chaos, le Dieu-Roi se lança dans une terrible incantation, dans")
    Sentence("une langue noire, gutturale, oubliée même des siens. Le sol se fissura jusqu'aux grandes portes d'or, le ciel")
    Sentence("s'assombrissant, les nuages noirs tournoyant au dessus du dernier rempart des hommes comme les charognards au")
    Sentence("dessus du champ de bataille, dans l'attente du charnier.")
    skip_touch()
    ...
    Sentence("fils nouveau-né, raison pour laquelle il a voulu changer ce monde, il aggrippe sa lame, et dans un dernier effort,")
    Sentence("mortellement blessé et couvert de honte d'abandonner ainsi les siens, lance son sort de téléportation.")
    skip_touch()
    ...
    Sentence("afin de bénir son fils héritier de la présence d'un ange véritable. Depuis ces jours, celui que l'on nomme le")
